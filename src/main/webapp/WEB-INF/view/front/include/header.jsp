	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				<a href="${pageContext.request.contextPath}/front/loginOut.action">退出</a>
				<a href="${pageContext.request.contextPath}/front/user/index.action?id=${sessionScope._front_user.id}" id="account">${sessionScope._front_user.email}</a>
			</div>
		</c:if>
		...
		<a onclick="JavaScri.pt:addFavorite2()"><img src="img/sc.png" draggable="false">加入收藏</a>
