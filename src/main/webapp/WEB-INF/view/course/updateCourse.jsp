		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath}/course/updateCourse.action" method="post">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3" placeholder="标题" name="courseNamee" value="${course.courseName}">
					</div>
				</div>
				
				<div class="form-group">
					<label for="text" class="col-sm-2 control-label">学科</label>
					<div class="col-sm-10">
						<select class="form-control" id="inputEmail3" name="subjectId">
						<c:forEach var="subject" items="${subject1}">
